import { updateNoteService } from '../../../../src/services/patient/note/updateNote';
...
describe('updateNoteService', () => {
  ...
  it('should call updateNoteQuery with noteId, patientId, and updateData and return the result', async () => {
    (updateNoteQuery as jest.Mock).mockResolvedValue({ id: 'n1', note: 'Updated note', date: '2023-01-02' });
    ...
    expect(result).toEqual({ id: 'n1', note: 'Updated note', date: '2023-01-02' });
  });
});
